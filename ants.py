...
class Ant(Insect):
    ...
    def can_contain(self, other):
        if self.is_container and not self.is_ant and not other.is_container:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while not bees and place is not hive:
            if self.min_range <= advancement <= self.max_range:
                bees = place.bees
...
class TankAnt(BodyguardAnt):
    ...
    def action(self, colony):
        ...
        bee_coming = self.place.bees
        for bee in list(bee_coming):
...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        #if insect.armor > 0:
            #return not insect.is_watersafe
        # END Problem 11
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        while True:
            ...
            if not place:
                break
            if place.ant and place.ant not in self.doubled_damage:
                place.ant.damage *= 2
                self.doubled_damage.append(place.ant)
            if place.ant and place.ant.is_container and place.ant.contained_ant:
                if place.ant.contained_ant not in self.doubled_damage:
                    place.ant.contained_ant.damage *= 2
                    self.doubled_damage.append(self.doubled_damage.append(place.ant))
